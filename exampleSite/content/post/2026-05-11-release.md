...
A slide-out TOC panel is now available on all pages. It shows headings for single pages and a post list for section/home pages. Toggle it with the list icon in the navbar. See [Layout Options](../../page/layout-options/).
